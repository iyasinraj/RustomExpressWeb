...
const MyAdsCard = ({ singleAd }) => {
    const { user, handleDeletePost, setDeleteId, localUrl } = useContext(AuthContext)
            ...
            <div className="modal">
                <div className="modal-box w-full max-w-5xl">
                    <form id="adsForm" onSubmit={handleSubmit(updatePost)}>
                        ...
                        <select defaultValue={singleAd.condition} {...register("condition", { required: true })} className="select select-bordered w-full">
                        ...
                        <input type="text" defaultValue={singleAd.title} {...register("title", { required: true })} placeholder="Title" className="input input-bordered w-full" />
                        ...
                        <textarea defaultValue={singleAd.description} {...register("description", { required: true })} className="textarea w-full min-h-[200px] textarea-bordered" placeholder="Description"></textarea>
                        ...
                        <input type="number" defaultValue={singleAd.price} {...register("price", { required: true })} placeholder="Price" className="input input-bordered w-full" />
                        ...
                        <input type="url" defaultValue={singleAd.additionalLink} placeholder="https://example.com" pattern="https://.*" {...register("link")} className="input input-bordered w-full" />
