...
const AdsCard = ({ singleAd }) => {
    ...
    return (
        <Link to={`/ads/${singleAd?._id}`} className="mx-4 h-[200px] rounded-md my-4 flex bg-base-100 hover:shadow-xl shadow-md">
            <img className='w-1/3 rounded-l-md' src={singleAd?.images[0]} alt="Movie" />
